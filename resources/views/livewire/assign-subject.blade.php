            ...
            <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                ...
                <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                    ...
                    <form class="mt-5" wire:submit="createSubject">
                        ...
                        <div class="mt-4">
                            <select wire:model="class_id" class="block w-full p-2 border border-gray-300 rounded">
                        ...
                        <div class="mt-4">
                            <select wire:model="teacher_id" class="block w-full p-2 border border-gray-300 rounded">
