<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                <x-label for="unique_number" value="{{ __('Unique Number') }}" />
                <x-input id="unique_number" class="block w-full mt-1" type="number" name="unique_number" :value="old('unique_number')" required autofocus autocomplete="username" />
            </div>
